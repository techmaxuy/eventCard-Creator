...
export function ShareButtons({
  ...
  const shareOnInstagram = () => {
    // Instagram no permite compartir URL directamente, abrimos el perfil o app
    // La mejor opción es copiar el link y abrir Instagram
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-4 gap-3">
        ...
        <button
          ...
          className="px-4 py-3 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-lg transition-colors flex items-center justify-center"
          title="WhatsApp"
        >
        ...
        <button
          ...
          className="px-4 py-3 bg-[#1877F2] hover:bg-[#166FE5] text-white rounded-lg transition-colors flex items-center justify-center"
          title="Facebook"
        >
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <button
          ...
          className="px-4 py-3 bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#F77737] hover:opacity-90 text-white rounded-lg transition-colors flex items-center justify-center"
          title="Instagram"
        >
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <button
          ...
          className="px-4 py-3 bg-[#0088cc] hover:bg-[#0077b5] text-white rounded-lg transition-colors flex items-center justify-center"
          title="Telegram"
        >
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
